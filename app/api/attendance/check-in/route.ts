...
// Ikki nuqta orasidagi masofani hisoblash (metr)
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (existing) {
      return NextResponse.json({ success: false, message: "Bugun allaqachon kirishni tasdiqlagan" }, { status: 400 });
    }
